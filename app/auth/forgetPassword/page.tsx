...
export default function ForgetPassword() {
  ...
  const renderStep = () => {
    switch (step) {
      case 1:
        return <div className='md:w-[444px]'>
      ...
      case 2:
        return <div className='md:w-[444px]'>
          ...
          <div className="w-full mt-[40px] login_submit_button" onClick={handleConfirm}>
            Confirm
          </div>
        </div>
      case 3:
        return <div className='md:w-[444px]'>
          ...
          <div className="md:w-[444px] mt-[40px]">
            <div className='text-[16px] font-[400] leading-[24px] myLabel'>New Password</div>
            ...
            <div className='text-[16px] font-[400] leading-[24px] mt-[16px] myLabel'>Confirm new Password</div>
  ...
  return <div className='h-full w-full flex md:items-center flex-col md:px-[0px] px-[20px]'>
    {
      renderStep()
    }
  </div>
