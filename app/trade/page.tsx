      ...
      <div className='trade_page'>
        ...
        <div className='trade_page_content'>
          ...
          <div className="flex mt-[16px]">
            {['07', '27', '59', '20'].map((item, index) => <div key={index} className={`flex flex-col items-center ${index === 3 ? 'mr-0' : 'mr-[48px]'}`}>
              <div className="text-[32px] text-black-0-9 font-[500] leading-[38.4px]">{item}</div>
          ...
          </div>)}
          {
            showMore ? <>
              <div className="h-[1px] bg-black-0-1 w-full my-[40px]"></div>
              {props2.map((item, index) => <div className={`${index === props.length - 1 ? '' : 'mb-[16px]'} flex justify-between`} key={index}>
                <div className="flex-1 text-[16px] font-[400] leading-[20px] text-black-0-3">{item.key}</div>
                {/* 下划线 */}
                <div className="flex-1 text-[16px] font-[400] leading-[20px] text-black-0-9 underline">{item.value}</div>
              </div>)}
              <div className="h-[40px]"></div>
            </> : <div className="h-[1px] bg-black-0-1 w-full mt-[40px]"></div>
          }
          <div className="flex items-center justify-center">
            <div
              onClick={() => setShowMore(!showMore)}
              className="p-[17px] text-black-0-3 cursor-pointer hover:text-black flex items-center">
              {showMore ? 'See less' : 'See more'}
              <svg
                className={`ml-[4px] ${!showMore ? 'rotate-180' : ''}`}
      ...
      <div className='trade_page_2'>
        ...
        <div className="grid grid-cols-3 gap-[40px]">
          ...
          <div>
            ...
            <div className="text-[20px] font-[500] leading-[32px] text-black-0-9 mt-[24px] VictorSherif ">We tokenize the artwork</div>
            <div className="text-[16px] font-[400] leading-[25.6px] text-black-0-6 mt-[16px] VictorSherif">
              We mint a limited number of tokens on the Sui network, each representing a fractional share of the artwork. After minting, the treasury cap will be revoked.
            </div>
          </div>
          <div>
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M18.6667 22.9334V35.7334C18.6667 36.6171 17.9503 37.3334 17.0667 37.3334H9.6C8.71635 37.3334 8 36.6171 8 35.7334V22.9334C8 22.0497 8.71635 21.3334 9.6 21.3334H17.0667C17.9503 21.3334 18.6667 22.0497 18.6667 22.9334Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M37.3337 36.2666V49.0666C37.3337 49.9504 36.6174 50.6666 35.7337 50.6666H28.267C27.3833 50.6666 26.667 49.9504 26.667 49.0666V36.2666C26.667 35.3829 27.3833 34.6666 28.267 34.6666H35.7337C36.6174 34.6666 37.3337 35.3829 37.3337 36.2666Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M55.9997 14.9334V27.7334C55.9997 28.6171 55.2834 29.3334 54.3997 29.3334H46.933C46.0493 29.3334 45.333 28.6171 45.333 27.7334V14.9334C45.333 14.0497 46.0493 13.3334 46.933 13.3334H54.3997C55.2834 13.3334 55.9997 14.0497 55.9997 14.9334Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <div className="text-[20px] font-[500] leading-[32px] text-black-0-9 mt-[24px] VictorSherif ">You trade tokens and access DeFi features</div>
            <div className="text-[16px] font-[400] leading-[25.6px] text-black-0-6 mt-[16px] VictorSherif ">
              {`You trade artwork tokens on Arttoo's AMM-based trading platform. Our platform offers a complete DeFi ecosystem where you can provide liquidity, stake tokens, access lending features, and explore more innovative financial opportunities powered by our DeFi partners – all in one place.`}
            </div>
          </div>
        </div>
        ...
        <div className="flex mb-[60px]">
          <div>
            <div className="text-[60px] font-[400] leading-[80px] text-black-0-9 VictorSherif">Valuation <span className="VictorSherif font-[500] italic">analytics</span></div>
            <div className="text-[16px] font-[400] leading-[25.6px] text-black-0-6 VictorSherif">Nature Morte avec des Fruits</div>
          </div>
          <div className="flex-1 flex justify-end items-end">
            <div className="min-w-[260px]">
              <div className="text-black-0-9 font-[400] leading-[38.4px] text-[32px]">$1,734,000</div>
              <div className="text-[16px] font-[500] leading-[25.6px] text-black-0-6 mt-[8px] VictorSherif">Initial Offering Price</div>
            </div>
            <div className="min-w-[260px] ml-[40px]">
              <div className="text-[#12B76A] font-[400] leading-[38.4px] text-[32px] flex items-center">
                <svg
                  className="mr-[8px]"
              ...
              <div className="text-[16px] font-[500] leading-[25.6px] text-black-0-6 mt-[8px] VictorSherif">Annual Growth of Record Price</div>
            </div>
          </div>
        </div>
        <div className="w-full h-[470px] bg-black-0-05"></div>
        <div className="h-[1px] bg-black-0-1 w-full my-[120px]"></div>
        <div className="flex mb-[60px]">
          <div>
            <div className="text-[60px] font-[400] leading-[80px] text-black-0-9 VictorSherif">Similar <span className="VictorSherif font-[500] italic">artworks</span></div>
            <div className="text-[16px] font-[400] leading-[25.6px] text-black-0-6 VictorSherif">Henri Matisse</div>
          </div>
          <div className="flex-1 flex justify-end items-end">
            {
              [
                ...
                <div key={index} className="min-w-[214px]">
                  <div className="text-black-0-9 font-[400] leading-[38.4px] text-[32px]">{item.num}</div>
                  <div className="text-[16px] font-[500] leading-[25.6px] text-black-0-6 mt-[8px] VictorSherif">{item.desc}</div>
                </div>
              ))
            }
          </div>
        ...
        <div className="grid grid-cols-3 gap-[40px]">
          {
            [
              ...
              <div>
                <img src={item.img} alt={item.title} className="h-[320px]" />
                <div className="text-[20px] font-[500] leading-[32px] text-black-0-9 VictorSherif mt-[40px]">{item.title}</div>
                <div className="text-[16px] font-[400] leading-[25.6px] text-black-0-6 VictorSherif mt-[4px]">{item.desc}</div>
                <div className="text-[24px] font-[500] leading-[38.4px] text-black-0-9 VictorSherif mt-[16px]">{item.price}</div>
                <div className="text-[16px] font-[400] leading-[25.6px] text-black-0-6 VictorSherif mt-[4px]">{item.lastSale}</div>
                <div className="text-[16px] font-[400] leading-[25.6px] text-black-0-6 VictorSherif mt-[4px]">{item.time}</div>
              </div>
            </div>)
          }
        </div>
        ...
        <div className="flex">
          <div className="flex-1 mr-[80px]">
            ...
            <div className="mt-[104px]">
              ...
              <div className="text-[20px] mt-[122px] font-[400] leading-[32px] text-black-0-9 VictorSherif">Matisse was no timid artist. He was a bold, brazen revolutionary who dared to defy the rules of art. With his Fauvist comrades, he unleashed a riot of color onto the canvas, shocking the art world with his audacious brushstrokes and disregard for traditional representation. But Matisse was no one-trick pony. He was a shape-shifter, constantly exploring new avenues of artistic expression. From the vibrant intensity of his early works to the serene, almost ethereal beauty of his later cut-outs, Matisse was a master of reinvention. </div>
            </div>
          </div>
        ...
        <div className="h-[1px] bg-black-0-1 w-full my-[120px]"></div>
        <div className="text-[60px] font-[400] mb-[60px] leading-[80px] text-black-0-9 VictorSherif">Artist Career <span className="font-[500] VictorSherif italic">Path</span></div>
